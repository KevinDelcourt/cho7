...
import { getCreation, getEtatsCreation, postUpdateCreation } from '../../modules/api';
			...
			return (
					...
					<Template>
                        <MainContainer title="MODIFIER CRÉATION">
							{this.state.creation?
								<UploadForm onSubmit={this.onSubmit} initialValues={this.state.creation} lock={true}/>
								:""
							}
						</MainContainer>
						{this.state.redirect}
...
export default connect(null,mapDispatchToProps)(UpdateCreationPage);