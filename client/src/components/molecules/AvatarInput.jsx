...
class AvatarInput extends Component {
    ...
    render = () => {
        ...
        return (
            <AvatarContainer >
                <Avatar src={this.state.fichier? URL.createObjectURL(this.state.fichier) : getImageUrl(this.props.avatar)}/>
                <input {...this.props.input} type="file" onChange={this.fileSelect} name={this.props.name}/>   
