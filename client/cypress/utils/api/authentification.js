...
export const login = (credentials, cb) => postRequest("/login", credentials, cb)

export const loginAsCreateur = () =>
    login({ username: "Admin", password: "Admin" }, res => {
...
export const isCreateur = () =>
    has_role("CREATEUR", res => {
        expect(res.body).to.be.true
    })

export const isNotCreateur = () =>
    has_role("CREATEUR", res => {
